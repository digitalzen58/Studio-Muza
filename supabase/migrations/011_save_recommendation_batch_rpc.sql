-- Migration: 011_save_recommendation_batch_rpc.sql
-- Description: RPC function to atomically save a recommendation batch and its child recommendations.
...
-- Security Hardening: Revoke all from PUBLIC and anon, grant ONLY to authenticated
