...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-cream text-ink flex flex-col justify-between p-6 max-w-md mx-auto relative overflow-hidden">
      {/* Subtle decorative background blur */}
      <div className="absolute -top-20 -right-20 w-72 h-72 bg-primary-light rounded-full blur-3xl opacity-60 pointer-events-none" />
      ...
      <header className="flex items-center justify-between pt-4 z-10">
        ...
        <Badge variant="primary" showSymbol>
          Mobile-First
        </Badge>
      </header>
      ...
      <main className="my-auto py-12 flex flex-col gap-6 z-10">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl leading-[1.15] text-ink font-normal">
          Mūza propose.{' '}
          <span className="italic text-primary">Vous choisissez.</span>{' '}
        ...
        <Card className="flex flex-col gap-3 bg-white border-cream-border mt-2">
