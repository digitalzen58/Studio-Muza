...
export function CreationChooserModal({
  ...
  return (
    ...
    >
      <div className="bg-white border border-cream-border rounded-3xl w-full max-w-sm shadow-xl p-5 flex flex-col gap-4 animate-scaleUp">
        {/* Header */}
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={onClose}
            disabled={isPending}
            className="p-1.5 text-ink-muted hover:text-ink rounded-full hover:bg-cream-subtle transition-colors"
            aria-label="Fermer"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="flex flex-col gap-2.5 pt-1">
          ...
          <button
            ...
            disabled={isPending}
            className="w-full text-left p-4 rounded-2xl border border-cream-border bg-white hover:border-primary hover:bg-primary-light/30 transition-all group flex items-start gap-3.5 shadow-2xs hover:shadow-xs active:scale-[0.99]"
          >
            <div className="w-10 h-10 rounded-xl bg-primary-light text-primary flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-sm font-semibold text-ink group-hover:text-primary-dark transition-colors">
                Une publication
              </span>
          ...
          <div
            className="w-full text-left p-4 rounded-2xl border border-dashed border-cream-border bg-cream-subtle/50 opacity-65 flex items-start justify-between gap-3 cursor-not-allowed select-none"
            aria-disabled="true"
          >
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-cream-border/50 text-ink-muted flex items-center justify-center shrink-0">
