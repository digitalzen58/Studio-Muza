    ...
    <div className="w-full max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="space-y-6">
        ...
        <Card className="p-5 sm:p-6 rounded-2xl border border-cream-border bg-white shadow-xs space-y-4">
          <div className="flex items-center gap-3 border-b border-cream-border/60 pb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div className="p-3.5 rounded-xl bg-cream-subtle border border-cream-border/60 space-y-1">
        ...
        <Card className="p-5 sm:p-6 rounded-2xl border border-cream-border bg-white shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary-hover text-white rounded-xl text-xs font-semibold transition-all shadow-xs shrink-0 self-start sm:self-center"
            >
          ...
          {activeCount > 0 ? (
            ...
            <div className="p-3.5 rounded-xl bg-cream-subtle border border-cream-border/60 text-xs text-ink-muted">
